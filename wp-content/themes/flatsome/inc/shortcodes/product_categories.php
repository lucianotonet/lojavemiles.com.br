...
function ux_product_categories($atts, $content = null) {
  ...
  **/
  ...
  ?>
    ...
    <?php if($type == 'slider') slider_script($sliderrandomid,$columns,$infinitive); ?>
   ...
   <?php } ?>
                <ul class=" <?php if($type == 'slider') { ?>slider<?php } ?> large-block-grid-<?php echo $columns; ?> small-block-grid-2">
          <?php
