...
function ux_shortcode_add_tinymce_plugin($plugin_array) {
    $plugin_array['ux_shortcode_insert'] = get_template_directory_uri().'/inc/shortcodes/inserter/shortcode_insert.js'; // CHANGE THE BUTTON SCRIPT HERE
    return $plugin_array;
}
...
function ux_shortcode_css() {
    wp_enqueue_style('ux_shortcode_insert_css', get_template_directory_uri().'/inc/shortcodes/inserter/style.css');
}
